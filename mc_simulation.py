#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — POPs Beyond PFAS / Bioaccumulation Ratchet
==========================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: POPs Beyond PFAS (Bioaccumulation Ratchet).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "pops",
    "domain_name": "POPs Beyond PFAS",
    "theorem": "Bioaccumulation Ratchet",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 70.0,
    "channels": {
        "C1_health_bioaccumulation": {
            "dist": "lognormal",
            "low": 82.2,
            "mid": 149.4,
            "high": 246.5,
            "weight": 0.3,
            "description": "Bioaccumulation, cancer, endocrine disruption. Sources: Stockholm Convention, WHO, IARC."
        },
        "C2_ecosystem_contamination": {
            "dist": "lognormal",
            "low": 70.5,
            "mid": 128.1,
            "high": 211.4,
            "weight": 0.25,
            "description": "Global water/soil/biota contamination, Arctic transport. Sources: AMAP, UNEP."
        },
        "C3_remediation_costs": {
            "dist": "lognormal",
            "low": 47.0,
            "mid": 85.4,
            "high": 140.9,
            "weight": 0.2,
            "description": "Superfund-scale cleanup, perpetual monitoring. Sources: EPA, Stockholm COP."
        },
        "C4_intergenerational_exposure": {
            "dist": "lognormal",
            "low": 23.5,
            "mid": 42.7,
            "high": 70.5,
            "weight": 0.15,
            "description": "Prenatal exposure, breast milk, epigenetics. Sources: Lancet, EHP."
        },
        "C5_regulatory_lag": {
            "dist": "normal",
            "low": 17.1,
            ...
            "high": 25.7,
            "weight": 0.1,
            "description": "Stockholm listing delays 10+ yrs, exemption abuse. Sources: UNEP, IPEN."
        }
    },
